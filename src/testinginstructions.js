...
function TestingInstructions() {
  return (
    <div className="testing-instructions">
      ...
      <ul>
        <li>Thank you so much for testing. Please note that although this is testing site, and I have done everything I can to make sure 
            you are unable to connect to any Main networks. Please take a moment to ensure you are using the Arbitrum Sepolia network.
            You can check this by clicking the network name at the top of the page. And while this is a testing site, please be aware that
        ...
        <li>Ensure you have some testnet (MOR, ETH) in your wallet. if you don't saMOR can be found at <a href="https://morfaucet.xyz/" target="_blank"> MorFaucet.xyz (new tab) </a> And saETH can 
        be found at <a href="https://faucets.chain.link/sepolia" target="_blank"> faucets.chain.link/sepolia (new tab) </a> This is my favorite faucet.</li>
      ...
      <p>If you encounter any issues or have questions, please enter issues in the Github</p>
